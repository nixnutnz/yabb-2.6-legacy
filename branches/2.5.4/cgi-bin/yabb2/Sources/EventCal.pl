...
$eventcalplver = 'YaBB 2.5.4 $Revision: 1.0 $';
	...
	if ($INFO{'showthisdate'} || $INFO{'showmini'} || $INFO{'edit_cal_even'}) {
		...
		<tr>
			<td align="left" class="$title_class" colspan="2">
				<div style="float: left; width: 30%; padding-top: 1px; padding-bottom: 1px; text-align: left;"><img src="$yyhtml_root/Templates/Forum/default/eventcal.gif" border="0" alt="" /> $var_cal{'caltitle'}</div>
		...
		<tr>
			...
			<td class="tabtitle" width="29%" height="25" valign="middle" align="left">
				<img src="$yyhtml_root/Templates/Forum/default/eventcal.gif" border="0" alt="" /> $var_cal{'caltitle'}
			</td>
...
<table cellpadding="4" cellspacing="1" border="0" width="100%">~;
	...
	<tr>
		<td align="left" colspan="2" class="windowbg2">
			<img src="$yyhtml_root/Templates/Forum/default/eventbd.gif" border="0" alt="$var_cal{'calbirthday'}" /> $cdate <b>$var_cal{'calbirthday'}</b>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td align="left" colspan="2" class="windowbg2">~;
						...
						if ($ctyp == 2) {
							$yymain .= qq~
			<img src="$yyhtml_root/Templates/Forum/default/eventprivate.gif" border="0" alt="Event" /> <img src="$yyhtml_root/Templates/Forum/default/EventIcons/$cico.gif" border="0" alt="$icon_text" /> $cdate <b>$icon_text</b> $eventuserlink~;
						} else {
							$yymain .= qq~
			<img src="$yyhtml_root/Templates/Forum/default/EventIcons/$cico.gif" border="0" alt="$icon_text" /> $cdate <b>$icon_text</b> $eventuserlink~;
						}
			...
			<table>
				<tr>
					<td width=100% valign=top>
						<hr class="hr" />
						<img src="$yyhtml_root/Templates/Forum/default/EventIcons/eventinfo.gif" border="0" alt="Event" /> $var_cal{'calnoevent'}
						<hr class="hr" />
					</td>
				</tr>
			</table>
...
<table class="bordercolor" cellpadding="3" cellspacing="1" border="0" width="100%">~;
	...
	<tr>
		<td align="left" colspan="2" class="windowbg2">~;
						if ($ctyp == 2) {
							$yymain .= qq~
			<img src="$imagesdir/eventprivate.gif" border="0" alt="Event" /> <img src="$yyhtml_root/Templates/Forum/default/EventIcons/$cico.gif" border="0" alt="$icon_text" /> $cdate <b>$icon_text</b> $eventuserlink~;
						} else {
							$yymain .= qq~
			<img src="$yyhtml_root/Templates/Forum/default/EventIcons/$cico.gif" border="0" alt="$icon_text" /> $cdate <b>$icon_text</b> $eventuserlink~;
						}
...
// -->
	...
	foreach $cal_events (sort @caldata) {
		...
		if ($CalShortEvent && length($cevent) > $CalShortEvent) {
			unless ($ctime eq "birthday") {
				...
				$cevent = $convertstr;
				$cevent .= " ..." if $cliped;
				$cevent .= qq~<br /><br /><a  href="$scripturl?action=get_cal;calshow=1;eventdate=$cyear$cmon$cday;calid=$ctime;showthisdate=1" title="$var_cal{'calshowevent'}"><font color="#FF6600">$var_cal{'calmore'}</font> <img  src="$yyhtml_root/Templates/Forum/default/eventmore.gif" border="0" alt="$var_cal{'calshowevent'}" /></a>~; # There MUST be two spaces after "<a" and "<img" here or you will get this message here after going through &DoUBBC: "Multimedia File Viewing and Clickable Links are available for Registered Members only!! You need to Login or Register"
			}
		}
		if ($enable_ubbc) {
			$message = $cevent;
		...
		if ($event_found == 1) {
			...
			if ($Scroll_Events == 3) {
				if ($cicon eq "birthday") {
					$outstring .="<div><span class=\"small\"><img src=\"$yyhtml_root/Templates/Forum/default/eventbd.gif\" border=\"0\" alt=\"$var_cal{'calbirthday'}\" /> $cdate <b>$var_cal{'calbirthday'}</b><br /> $eventbduserlink $var_cal{'calis'} $cevent $var_cal{'calold'}</span><hr class=\"hr\" size=\"1\" /></div>";
				} elsif ($ctype == 2) {
					$outstring .="<div><span class=\"small\"><img src=\"$yyhtml_root/Templates/Forum/default/eventprivate.gif\" border=\"0\" alt=\"$var_cal{'calprivate'} Event\" /> <img src=\"$yyhtml_root/Templates/Forum/default/EventIcons/$cicon.gif\" border=\"0\" alt=\"$icon_text\" /> $cdate <b>$icon_text</b> $eventuserlink<br />$cevent</span><hr class=\"hr\" size=\"1\" /></div>";
				} else {
					$outstring .="<div><span class=\"small\"><img src=\"$yyhtml_root/Templates/Forum/default/EventIcons/$cicon.gif\" border=\"0\" alt=\"$icon_text\" /> $cdate <b>$icon_text</b> $eventuserlink<br />$cevent</span><hr class=\"hr\" size=\"1\" /></div>";
				}
			} else {
				if ($cicon eq "birthday") {
					$outstring .="<tr><td width=\"100%\" valign=\"top\"><span class=\"small\"><img src=\"$yyhtml_root/Templates/Forum/default/eventbd.gif\" border=\"0\" alt=\"$var_cal{'calbirthday'}\" /> $cdate <b>$var_cal{'calbirthday'}</b><br /> $eventbduserlink $var_cal{'calis'} $cevent $var_cal{'calold'}</span><hr class=\"hr\" size=\"1\" /></td></tr>";
				} elsif ($ctype == 2) {
					$outstring .="<tr><td width=\"100%\" valign=\"top\"><span class=\"small\"><img src=\"$yyhtml_root/Templates/Forum/default/eventprivate.gif\" border=\"0\" alt=\"$var_cal{'calprivate'} Event\" /> <img src=\"$yyhtml_root/Templates/Forum/default/EventIcons/$cicon.gif\" border=\"0\" alt=\"$icon_text\" /> $cdate <b>$icon_text</b> $eventuserlink<br />$cevent</span><hr class=\"hr\" size=\"1\" /></td></tr>";
				} else {
					$outstring .="<tr><td width=\"100%\" valign=\"top\"><span class=\"small\"><img src=\"$yyhtml_root/Templates/Forum/default/EventIcons/$cicon.gif\" border=\"0\" alt=\"$icon_text\" /> $cdate <b>$icon_text</b> $eventuserlink<br />$cevent</span><hr class=\"hr\" size=\"1\" /></td></tr>";
				}
			}
		}
	}
	...
	if ($Show_BirthdaysList) {
		unless ($iamguest && ($Show_BirthdaysList == 1)) {
			$ShowBirthdaysLink = qq~<span class="small"> <img src="$yyhtml_root/Templates/Forum/default/eventmore.gif" border="0" alt="$var_calpost{'var_cal'}" /> <a href="$scripturl?action=cal_birthdaylist">$var_cal{'calbdaylist'}</a></span>~;
		}
	}
	if ($Allow_Event_Imput && !$INFO{'addnew'} == 1) {
		$ShowEventAddLink = qq~<br /><span class="small"> <img src="$yyhtml_root/Templates/Forum/default/eventmore.gif" border="0" alt="$var_calpost{'getaddevent'}" /> <a href="$scripturl?action=get_cal;calshow=1;addnew=1">$var_calpost{'getaddevent'}</a></span>~;
	}
	...
	for ($i = 1; $i <= $days; $i++) {
		...
		if (exists(${event.$year.$view_mon.$dddd}{'calday'}) && !exists(${bday.$year.$view_mon.$dddd}{'calday'})) {
			$cal_pic = "$yyhtml_root/Templates/Forum/default/EventIcons/eventinfo.gif";
		}
		if (exists(${event.$year.$view_mon.$dddd}{'calday'}) && exists(${bday.$year.$view_mon.$dddd}{'calday'})) {
	...
	if ($outstring !~ /$yyhtml_root\/ModImages\//) {
		$outstring = "<table><tr><td width=\"100%\" valign=\"top\"><span class=\"small\"><img src=\"$yyhtml_root/Templates/Forum/default/EventIcons/eventinfo.gif\" border=\"0\" alt=\"Event\" /> $var_cal{'calnoevent'}</span><hr class=\"hr\" size=\"1\" /></td></tr></table>";
	}
...
<tr>
	<td class="windowbg" width="5%" valign="middle" align="center">
		<img src="$yyhtml_root/Templates/forum/default/eventcal.gif" border="0" alt="" />
	</td>
