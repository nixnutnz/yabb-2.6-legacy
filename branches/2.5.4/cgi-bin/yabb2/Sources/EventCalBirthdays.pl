...
$eventcalbirthdaysplver = 'YaBB 2.5.4 $Revision: 1.0 $';
...
<td class="titlebg" colspan="4">
		<div style="float: left; width: 30%; padding-top: 1px; padding-bottom: 1px; text-align: left;"><img align="bottom" src="$yyhtml_root/ModImages/EventCal/eventcal.gif" border="0" alt="" /> $var_cal{'caltitle'}</div>
...
<table width="100%" cellspacing="1" cellpadding="4">
	<tr valign="middle">
		<td colspan="4" align="left" class="titlebg">
			<img align="bottom" src="$yyhtml_root/ModImages/EventCal/eventbd.gif" border="0" alt="$var_cal{calbirthday}" /> <b>$var_cal{'calmon_01'}</b> ($countJanuary)
		</td>
	</tr>
$cal_info_header
$view_January
...
<table width="100%" cellspacing="1" cellpadding="4">
	<tr valign="middle">
		<td  colspan="4" align="left" class="titlebg">
			<img align="bottom" src="$yyhtml_root/ModImages/EventCal/eventbd.gif" border="0" alt="$var_cal{calbirthday}" /> <b>$var_cal{'calmon_02'}</b> ($countFebruary)
		</td>
	</tr>
$cal_info_header
$view_February
...
<table width="100%" cellspacing="1" cellpadding="4">
	<tr valign="middle">
		<td  colspan="4" align="left" class="titlebg">
			<img align="bottom" src="$yyhtml_root/ModImages/EventCal/eventbd.gif" border="0" alt="$var_cal{calbirthday}" /> <b>$var_cal{'calmon_03'}</b> ($countMarch)
		</td>
	</tr>
$cal_info_header
$view_March
...
<table width="100%" cellspacing="1" cellpadding="4">
	<tr valign="middle">
		<td  colspan="4" align="left" class="titlebg">
			<img align="bottom" src="$yyhtml_root/ModImages/EventCal/eventbd.gif" border="0" alt="$var_cal{calbirthday}" /> <b>$var_cal{'calmon_04'}</b> ($countApril)
		</td>
	</tr>
$cal_info_header
$view_April
...
<table width="100%" cellspacing="1" cellpadding="4">
	<tr valign="middle">
		<td  colspan="4" align="left" class="titlebg">
			<img align="bottom" src="$yyhtml_root/ModImages/EventCal/eventbd.gif" border="0" alt="$var_cal{calbirthday}" /> <b>$var_cal{'calmon_05'}</b> ($countMay)
		</td>
	</tr>
$cal_info_header
$view_May
...
<table width="100%" cellspacing="1" cellpadding="4">
	<tr valign="middle">
		<td  colspan="4" align="left" class="titlebg">
			<img align="bottom" src="$yyhtml_root/ModImages/EventCal/eventbd.gif" border="0" alt="$var_cal{calbirthday}" /> <b>$var_cal{'calmon_06'}</b> ($countJune)
		</td>
	</tr>
$cal_info_header
$view_June
...
<table width="100%" cellspacing="1" cellpadding="4">
	<tr valign="middle">
		<td  colspan="4" align="left" class="titlebg">
			<img align="bottom" src="$yyhtml_root/ModImages/EventCal/eventbd.gif" border="0" alt="$var_cal{calbirthday}" /> <b>$var_cal{'calmon_07'}</b> ($countJuly)
		</td>
	</tr>
$cal_info_header
$view_July
...
<table width="100%" cellspacing="1" cellpadding="4">
	<tr valign="middle">
		<td  colspan="4" align="left" class="titlebg">
			<img align="bottom" src="$yyhtml_root/ModImages/EventCal/eventbd.gif" border="0" alt="$var_cal{calbirthday}" /> <b>$var_cal{'calmon_08'}</b> ($countAugust)
		</td>
	</tr>
$cal_info_header
$view_August
...
<table width="100%" cellspacing="1" cellpadding="4">
	<tr valign="middle">
		<td  colspan="4" align="left" class="titlebg">
			<img align="bottom" src="$yyhtml_root/ModImages/EventCal/eventbd.gif" border="0" alt="$var_cal{calbirthday}" /> <b>$var_cal{'calmon_09'}</b> ($countSeptember)
		</td>
	</tr>
$cal_info_header
$view_September
...
<table width="100%" cellspacing="1" cellpadding="4">
	<tr valign="middle">
		<td  colspan="4" align="left" class="titlebg">
			<img align="bottom" src="$yyhtml_root/ModImages/EventCal/eventbd.gif" border="0" alt="$var_cal{calbirthday}" /> <b>$var_cal{'calmon_10'}</b> ($countOctober)
		</td>
	</tr>
$cal_info_header
$view_October
...
<table width="100%" cellspacing="1" cellpadding="4">
	<tr valign="middle">
		<td  colspan="4" align="left" class="titlebg">
			<img align="bottom" src="$yyhtml_root/ModImages/EventCal/eventbd.gif" border="0" alt="$var_cal{calbirthday}" /> <b>$var_cal{'calmon_11'}</b> ($countNovember)
		</td>
	</tr>
$cal_info_header
$view_November
...
<table width="100%" cellspacing="1" cellpadding="4">
	<tr valign="middle">
		<td  colspan="4" align="left" class="titlebg">
			<img align="bottom" src="$yyhtml_root/ModImages/EventCal/eventbd.gif" border="0" alt="$var_cal{calbirthday}" /> <b>$var_cal{'calmon_12'}</b> ($countDecember)
		</td>
	</tr>
$cal_info_header
$view_December
