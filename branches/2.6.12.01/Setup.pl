...
$setupplver  = 'YaBB 2.6.12 $Revision: 2042 $';
$yymycharset = 'UTF-8';
...
Visit [url=http://www.yabbforumsoftware.com]YaBB[/url] today ;)
Signup for free on our forum and benefit from new features!
Latest info can be found on the [url=http://www.yabbforumsoftware.com/cgi-bin/yabb2/YaBB.pl]YaBB Chat and Support Community[/url].
NEWS
