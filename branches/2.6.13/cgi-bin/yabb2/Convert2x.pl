        ...
        <table class="cs_thin pad_4px">
            ...
            <tr>
                ...
                <td class="windowbg2 fontbigger">
                    Make sure your YaBB 2.6.13 installation is running and that it has all the correct folder paths and URLs.
                    ...
                    <br />Proceed through the following steps to convert your YaBB 2x forum to YaBB 2.6.13.<br />
                    <br /><b>If</b> your YaBB 2x forum is located on the same server as your new YaBB 2.6.13 installation:
                    <ol>
                    ...
                    <b>Else</b> if your old YaBB 2x forum is located on a different server than your new YaBB 2.6.13 installation <strong>or</strong> if you do not know the path to your YaBB 2x forum:
                    <ol>
                        <li>Copy all files in the /Boards, /Members, /Messages, and /Variables folders from your old YaBB 2x installation to the corresponding Convert/Boards, Convert/Members, Convert/Messages, and Convert/Variables folders of your new YaBB 2.6.13 installation, and CHMOD them to 755. In this case the Path to your YaBB 2x folders is './Convert'.</li>
                        <li>Click on the 'Continue' button</li>
                    </ol>
...
"Boards conversion (cats2) 'bstart' ($INFO{'bstart'}) or 'bfstart' ($INFO{'bfstart'}) error!"
    ...
    <table class="cs_thin pad_4px">
        ...
        <col style="width:95%" />
        <tr>
            <td class="titlebg" colspan="2">YaBB 2.6.13 Converter</td>
       </tr><tr>
           <td class="windowbg center">
               <img src="$imagesdir/thread.gif" alt="" />
           </td>
    ...
    <table class="cs_thin pad_4px">
        <tr>
          ...
          . int( ( $INFO{'st'} + 60 ) / 60 ) . qq~ minute(s)</i>.<br />
                ...
                <br />
                <br />
                You may now login to your forum. Enjoy using YaBB 2.6.13!
            </td>
        </tr><tr>
            <td class="catbg center" colspan="2">
$convset
...
<div class="bordercolor" style="padding: 0px; width: 100%; margin-left: 0px; margin-right: 0px;">
    ...
    $yyim    = 'YaBB 2.6.13 Convert2x Utility has already been run.';
    $yytitle = 'YaBB 2.6.13 Convert2x Utility';
    SetupTemplate();
    return;
}
