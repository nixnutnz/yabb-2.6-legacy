...
$convertplver = 'YaBB 2.6.13 $Revision: 1667 $';
...
if ( -e "$vardir/Setup.lock" ) {
    ...
    <form action="$set_cgi?action=prepare" id="prepare" method="post">
        <table class="cs_thin pad_4px">
            ...
            <tr>
                <td class="tabtitle" colspan="2">YaBB 2.6.13 Converter</td>
            </tr><tr>
                <td class="windowbg center">
                    <img src="$imagesdir/thread.gif" alt="" />
                </td>
                <td class="windowbg2 fontbigger">
                    Make sure your YaBB 2.6.13 installation is running and that it has all the correct folder paths and URLs.<br />
                    Proceed through the following steps to convert your YaBB 1 Gold - SP 1.x forum to YaBB 2.6.13.<br /><br />
                    <b>If</b> your YaBB 1 Gold - SP 1.x forum is located on the same server as your YaBB 2.6.13 installation:
                    <ol>
                    ...
                    <b>OR</b> if your YaBB 1 Gold - SP 1.x forum is located on a different server than your YaBB 2.6.13 installation or if you do not know the path to your SP 1.x forum:
                    <ol>
                        <li>Copy all files in the /Boards, /Members, /Messages, and /Variables folders from your YaBB 1 Gold - SP 1.x installation, to the corresponding Convert/Boards, Convert/Members, Convert/Messages, and Convert/Variables folders of your YaBB 2.6.13 installation, and chmod them 755. In this case the Path to your YaBB 1x folders is './Convert'.</li>
                        <li>Copy Settings.pl from the yabb folder of your YaBB 1 Gold - SP 1.x installation to the Convert/Variables folder of your YaBB 2.6.13 installation, and CHMOD it 644.</li>
                        <li>Click on the 'Continue' button</li>
                    </ol>
...
"Date &amp; Time conversion (dates2) error! pollfile($INFO{'pollfile'}), polledfile($INFO{'polledfile'})",
    ...
    <script type="text/javascript">
        ...
        if ( !$INFO{'clean'} ) {
            ...
            $firstmstime = time();
            print {$FORUMTOTALS}
"general|1|1|$firstmstime|admin|$firstmstime|0|Welcome to your new YaBB 2.6.13 forum!|xx|0|\n"
              or croak 'cannot print FORUMTOTALS';
            ...
            print {$FIRSTMS}
qq~Welcome to your New YaBB 2.6.13 Forum!|Administrator|$initmail|$firstmstime|admin|xx|0|127.0.0.1|Welcome to your new YaBB 2.6.13 forum.<br /><br />The YaBB team would like to thank you for choosing Yet another Bulletin Board for your forum needs. We pride ourselves on the cost (FREE), the features, and the security. Visit http://www.yabbforum.com to view the latest development information, read YaBB news, and participate in community discussions.<br /><br />Make sure you login to your new forum as an administrator and visit the Admin Center. From there, you can maintain your forum. You'll want to look at all of the settings, membergroups, categories/boards, and security options to make sure they are set properly according to your needs.||||\n~;
    ...
    <table class="cs_thin pad_4px">
        ...
        <tr>
          ...
          . int( ( $INFO{'st'} + 60 ) / 60 ) . qq~ minutes</i>.<br />
                ...
                <br />
                <br />
                You may now log in to your forum. If your old forum had Extended Profiles installed, you should turn on Extended Profiles in Admin Center -&gt; Forum Settings -&gt; Members and run the Extended Profiles converter from Admin Center -&gt; Profile Fields. Enjoy using YaBB 2.6.13!
            </td>
        </tr><tr>
            <td class="catbg center" colspan="2">
...
"Clean Up (cleanup2) error! pass_error($INFO{'pass_error'}), my_re_tot($INFO{'my_re_tot'}), memb_index($INFO{'memb_index'}), my_mail_n($INFO{'my_mail_n'})",
    ...
    $yyim    = 'You are running the YaBB 2.6.13 Converter.';
    $yytitle = 'YaBB 2.6.13 Converter';
    SetupTemplate();
}
...
qq{general|general||This is the board for General Discussions.<br /><i>The board description can now hold multiple lines and can use HTML!</i>|admin|||||0||||1|||\n};
            open $BOARDFILE, '>',
                ...
                print {$BOARDFILE}
qq{1378046604|Welcome to your new YaBB 2.6.13 forum!|Administrator|webmaster\@yoursite.com|1378046604|0|admin|xx|0\n}
...
sub FoundConvLock {
    ...
    <table class="cs_thin pad_4px">
        <tr>
            <td class="ttabtitle" colspan="2">YaBB 2.6.13 Converter</td>
        </tr><tr>
            <td class="windowbg center">
                <img src="$imagesdir/info.png" alt="" />
            </td>
    ...
    $yyim    = 'YaBB 2.6.13 Converter has already been run.';
    $yytitle = 'YaBB 2.6.13 Converter';
    SetupTemplate();
    return;
}
...
sub setup_fatal_error {
    ...
    <p class="center"><a href="javascript:history.go(-1)">Back</a></p>
      ~;
    $yyim    = 'YaBB 2.6.13 Convertor Error.';
    $yytitle = 'YaBB 2.6.13 Convertor Error.';
...
sub SetInstall2 {
    ...
    $settings_file_version = 'YaBB 2.6.13';
