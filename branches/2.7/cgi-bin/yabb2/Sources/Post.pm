...
our (
    ...
    $idinfo,               $js_pstat,       $language,
    $lastmod,              $mename,         $menusep,
    $mess,                 $messageclass,   $mfn,
    $multi_choice,         $my_is_prev,     $nolinkallow,
    $nscheck,              $numpoll,        $pie_legends,
    $pie_radius,           $poll_comment,   $poll_end,
    $poll_locked,          $poll_question,  $postid,
    $quick_post,           $quotemsg,       $reason,
    $sessionvalid,         $showall,        $showcheck,
    $spam_hits_left_count, $spam_image,     $spam_question,
    $spam_question_id,     $staff,          $thestatus,
    $thismusername,        $threadclass,    $threadcount,
    $tmpmdate,             $uid,            $user_ip,
    $username,             $verification,   $view,
    $vote_limit,           $yy_threadline,  $yyinlinestyle,
    $yymain,               $yynavigation,   $yysetlocation,
    $yytitle,              %addmembergroup, %board,
    %catinfo,              %FORM,           %format,
    %iconlist,             %INFO,           %link,
    %memberinf,            %memberinfo,     %memberstar,
    %moderatorgroups,      %moderators,     %newload,
    %theboard,             %thethread,      %thread_arrayref,
    %threadid,             %useraccount,    %usernames_life_quote,
    %yy_udloaded,          @options,        @repliers,
    @split,
);
## templates ##
our (
