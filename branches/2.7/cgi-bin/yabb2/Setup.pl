...
sub SetInstall2 {
    if ( $action eq 'checkmodules' || $action eq 'setinstall2' ) {
        ...
        $max_log_days_old       = 90;
        $fadertime              = 1000;
        $defaultusertxt         = 'I Love YaBB 2.7.00!';
        $timeout                = 5;
        $HotTopic               = 10;
        $VeryHotTopic           = 25;
        $barmaxdepend           = 0;
...
\$forumstart = q~$forumstart~;                       # The start date of your YaBB Forum
\$Cookie_Length = $Cookie_Length;                   # Default to set login cookies to stay for
\$cookieusername = q~$cookieusername~;               # Name of the username cookie
\$cookiepassword = q~$cookiepassword~;               # Name of the password cookie
\$cookiesession_name = q~$cookiesession_name~;       # Name of the Session cookie
\$cookietsort = q~$cookietsort~;                     # Name of the Topic Sort
\$cookieview = q~$cookieview~;                       # Name of the Guest Message Limit cookie
\$cookieviewtime = q~$cookieviewtime~;
...
\$pwstrengthmeter_scores = q~10,15,30,40~;           # Password-Strength-Meter Scores
\$pwstrengthmeter_common = q~"123","123456"~;      # Password-Strength-Meter common words
...
\$lang = q~$lang~;                                   # Default Forum Language
\$default_template = q~$default_template~;           # Default Forum Template

\$mailprog = q~$mailprog~;                           # Location of your sendmail program
\$smtp_server = q~$smtp_server~;                     # Address of your SMTP-Server (for Net::SMTP::TLS, specify the port number with a ":<portnumber>" at the end)
