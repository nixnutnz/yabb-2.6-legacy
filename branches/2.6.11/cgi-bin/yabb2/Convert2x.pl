        ...
        <table class="cs_thin pad_4px">
            ...
            <tr>
                ...
                <td class="windowbg2 fontbigger">
                    Make sure your YaBB 2.6.11 installation is running and that it has all the correct folder paths and URLs.
                    ...
                    <ol>
                        <li>Copy all files in the /Boards, /Members, /Messages, and /Variables folders from your old YaBB 2x installation to the corresponding Convert/Boards, Convert/Members, Convert/Messages, and Convert/Variables folders of your new YaBB 2.6.11 installation, and CHMOD them to 755. In this case the Path to your YaBB 2x folders is './Convert'.</li>
                        <li>Click on the 'Continue' button</li>
                    </ol>
