        ...
        <table class="cs_thin pad_4px">
            ...
            <tr>
                ...
                <td class="windowbg2 fontbigger">
                    ...
                    <b>OR</b> if your YaBB 1 Gold - SP 1.x forum is located on a different server than your YaBB 2.6.11 installation or if you do not know the path to your SP 1.x forum:
                    <ol>
                        <li>Copy all files in the /Boards, /Members, /Messages, and /Variables folders from your YaBB 1 Gold - SP 1.x installation, to the corresponding Convert/Boards, Convert/Members, Convert/Messages, and Convert/Variables folders of your YaBB 2.6.11 installation, and chmod them 755.</li>
...
"Date &amp; Time conversion (dates2) error! pollfile($INFO{'pollfile'}), polledfile($INFO{'polledfile'})",
    ...
    <script type="text/javascript">
        ...
        if ( !$INFO{'clean'} ) {
            ...
            $firstmstime = time();
            print {$FORUMTOTALS}
"general|1|1|$firstmstime|admin|$firstmstime|0|Welcome to your new YaBB 2.6.11 forum!|xx|0|\n"
              or croak 'cannot print FORUMTOTALS';
